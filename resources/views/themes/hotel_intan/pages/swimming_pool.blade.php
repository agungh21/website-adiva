    ...
    <section class="breadcrumb_area">
        ...
        <div class="container">
            <div class="page-cover text-center">
                <h2 class="page-cover-tittle">Swimming Pool</h2>
                <ol class="breadcrumb">
                    <li><a href="/">Home</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-6 d_flex align-items-center">
                                    <div class="about_content ">
                                        <h2 class="title title_color">Swimming Pool</h2>
                                ...
                                <div class="col-md-6">
                                    <img class="img-fluid"
                                        src="{{ themeUrl('assets/images/hotel/facilities-swimming-pool.jpg') }}" alt="img">
                                </div>
                            </div>
                        </div>
                    </section>

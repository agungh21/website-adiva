    ...
    <section class="breadcrumb_area">
        ...
        <div class="container">
            <div class="page-cover text-center">
                <h2 class="page-cover-tittle">Premier Suite</h2>
                <ol class="breadcrumb">
                    <li><a href="/">Home</a></li>
                    <li class="active">Premier Suite</li>
                </ol>
            </div>
        </div>
    </section>
                            ...
                            <div class="row">
                                <div class="col-md-6 d_flex align-items-center">
                                    <div class="about_content ">
                                        <h2 class="title title_color">Premier Suite</h2>
                                ...
                                <div class="col-md-6">
                                    <img class="img-fluid" src="{{ themeUrl('assets/images/hotel/room-3.jpg') }}"
                                        alt="img">
                                </div>
                            </div>
                        </div>
